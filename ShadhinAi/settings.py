...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'ShantonuAcharjee.pythonanywhere.com', 'shantonuacharjee.pythonanywhere.com']
...
WSGI_APPLICATION = "ShadhinAi.wsgi.application"
